...
Style:
- modern city media aesthetic
- Apple-style composition
- cinematic lighting
- realistic photography
- premium atmosphere
- rich shadows
- detailed skin and clothes
- glossy highlights
- magazine quality
...
The image must look like a premium photographed scene for a modern city media brand.
"""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "📸 Отправь фото\n"
        "✍️ Затем отправь заголовок\n\n"
        "Бот создаст афишу в стиле Афиша Минска."
    )
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # overlay design
        result = render_poster(ai_image, title)
